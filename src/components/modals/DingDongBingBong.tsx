...
export default function DingDongBingBongModal({visible, setVisible, onDone}:Props) {
  return (
    <Modal style={{flex: 1}} visible={visible}>
      <Video source={require('../../assets/video/Ding-Dong-Bing-Bong.mp4')} shouldPlay={true} resizeMode="cover"
        style={{width: '100%', height: '100%'}} onPlaybackStatusUpdate={(playbackStatus:any) => {
