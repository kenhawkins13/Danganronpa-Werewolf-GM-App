...
export const morningTimeSpeech = (name1?:string, name2?:string, name3?:string) => {
  return {
    ...
    bodyDiscovery4: name1 + " was Future Foundation and gets to pick three players to receive an item card. Be careful who you pick.",
...
export const dayTimeSpeech = (name?:string, killsLeft?:number) => {
  return {
    ...
    revealRole2: name + " was Future Foundation and gets to pick three players to receive an item card. Be careful who you pick.",
